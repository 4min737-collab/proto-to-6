...
export default function WireframeV1() {
  ...
  const handleDismissBubble = useCallback(() => setAlertShown(false), []);
  const handleOpenFromBubble = useCallback(() => {
    setAlertShown(false);
    setAiOpen(true);
    setHasAlert(false);
  }, []);
  const handleAlertConsumed = useCallback(() => setPendingAlert(null), []);

  return (
    <>
      <div className="design-note">
        <span className="tag">WIREFRAME v1</span>
